...
\keywords{Externally guided motion, EGM, robot, robotics, RobotStudio, virtual sensor, sensor simulation, ABB, sensor guided motion, sensor control, EGM framework, offline programming}


\sammanfattning{Användning av sensorer för att styra robotrörelse blir allt vanligare i robotik. Utveckling av robotprogram i simuleringar (så kallad offlineprogrammering) är en standard branschpraxis. Integration av sensorer i dessa simuleringar för sensorstyrning är ett relativt nytt fenomen jämfört med själva offlineprogrammeringen. Som sådan finns det oprövade metoder för att uppnå sensorstyrning av simulerade robotsystem. ABB styrenheter ger åtkomst till sina rörelsekontrollprocesser via gränssnittet för externt rörelsestyrning (EGM). Explorativ forskning och utveckling genomfördes i simulering av sensorstyrd robotik via EGM i RobotStudio (ABB:s offlineprogrammeringsmiljö). Denna forskning och utveckling ledde till en prototyp av ett ramverk för offlineprogrammering av sensorstyrda robotar genom EGM i RobotStudio. De relevanta forskningsresultaten och utvecklingsprocesserna som bidrog till ramverket dokumenteras härin.}

\nyckelord{Externt rörelsestyrning, EGM, robot, robotik, RobotStudio, virtuell sensor, sensorsimulering, ABB, sensorstyrd rörelse, sensorstyrning, EGM ramverk, offlineprogrammering}
